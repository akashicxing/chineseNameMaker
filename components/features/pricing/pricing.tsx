      ...
      <div className="container mx-auto px-4" ref={ref}>
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-4">
            Simple, Transparent <span className="text-red-600 dark:text-red-400">Pricing</span>
          </h2>
          <p className="text-xl text-gray-600 dark:text-gray-300">
            Choose the perfect plan for your Chinese name journey.
          </p>
        </div>
              ...
              <div className="p-6 md:p-8">
                ...
                <Button 
                  className={cn(
                    ...
                    plan.popular ? "bg-red-600 hover:bg-red-700 text-white" : "bg-gray-900 hover:bg-gray-800 text-white dark:bg-gray-700 dark:hover:bg-gray-600"
                  )}
                >
                  {plan.buttonText}
        ...
        <div className="mt-16 text-center max-w-3xl mx-auto">
          <p className="text-gray-600 dark:text-gray-300">
            Need a custom solution for your team or business? 
